...
function Rockpaper() {
  ...
  const handlePlayerMoveVsPlayer = (playerNum, choice) => {
    ...
    // Decide result if both choices are made
    if (playerChoice && playerTwoChoice) {
      if (playerChoice === playerTwoChoice) {
        setResult("It's a draw!");
      } else if (
        (playerChoice === 'rock' && playerTwoChoice === 'scissors') ||
        (playerChoice === 'paper' && playerTwoChoice === 'rock') ||
        (playerChoice === 'scissors' && playerTwoChoice === 'paper')
      ) {
